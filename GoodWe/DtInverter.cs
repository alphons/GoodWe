...
/// </summary>
public class DtInverter : Inverter
{
    ...
    [
        new TimestampSensor("timestamp",            30100, "Timestamp"),
    ...
    public DtInverter(InverterProtocol protocol) : base(protocol) { }
    ...
    public override async Task<Dictionary<string, object?>> ReadSettingsDataAsync(CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            resp.Seek(40327);
            result["grid_export_enabled"] = SensorHelper.ReadU16(resp);
            result["grid_export_limit"] = SensorHelper.ReadU16(resp);
        }
        catch { /* optional */ }
        return result;
    }
